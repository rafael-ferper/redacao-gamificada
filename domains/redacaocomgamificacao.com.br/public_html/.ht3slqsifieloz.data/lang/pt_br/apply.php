...
/**
 * Strings for component 'apply', language 'pt_br', version '4.1'.
 *
 * @package     apply
 * @category    string
...
$string['email_noreply'] = 'Este e-mail é automático. Por favor não responda.';
$string['email_notification'] = 'Enviar notificações por e-mail para o administrador';
...
$string['item_style'] = 'Estilo do item';
$string['items_are_required'] = 'As respostas são obrigatórias para itens com estrela.';
$string['label'] = 'Etiqueta';
$string['maximal'] = 'máxima';
$string['messageprovider:message'] = 'Mensagem';
$string['messageprovider:processed'] = 'Operação foi Processada';
$string['messageprovider:submission'] = 'Operação de Entrada';
...
$string['pagebreak'] = 'Quebra de página por dependência';
...
$string['printpagebreak'] = 'Adicionar quebra de página para impressão';
...
$string['table_border'] = 'Tamanho da borda dentro da tabela';
$string['table_border_help'] = 'O tamanho da borda externa da tabela será incrementado em 1';
$string['table_border_style'] = 'Estilo da borda dentro da tabela';
$string['table_border_style_help'] = 'O estilo da borda fora da tabela é solido (corrigir)';
$string['table_disp_iname'] = 'Mostrar nome do item';
$string['table_disp_iname_help'] = 'Mostrar nome do item na tabela';
$string['table_th_sizes'] = 'Largura (em px) de cada coluna';
$string['table_th_sizes_help'] = 'Especifique a largura (em px) de cada coluna separando por vírgulas.';
$string['table_th_strings'] = 'Título de cada coluna';
$string['tableend'] = 'Fim da tabela';
$string['tablestart'] = 'Início da tabela';
...
$string['username_manage'] = 'Gerenciar nome de usuário';
