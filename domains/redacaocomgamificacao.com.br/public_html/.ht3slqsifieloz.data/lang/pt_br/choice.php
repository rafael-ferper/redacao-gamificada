...
/**
 * Strings for component 'choice', language 'pt_br', version '4.1'.
 *
 * @package     choice
 * @category    string
...
$string['indicator:cognitivedepthdef_help'] = 'O participante atingiu esta porcentagem de engajamento cognitivo oferecido pelas atividades de Escolha durante este intervalo de análise (Níveis = Sem visualização, Visualização, Enviar, Visualizar feedback)';
