...
/**
 * Strings for component 'moodle', language 'pt_br', version '4.1'.
 *
 * @package     moodle
 * @category    string
...
$string['activityheader'] = 'Menu de atividades';
$string['activityicon'] = '{$a} ícone';
...
$string['activitynotready'] = 'Atividade não está pronta';
...
$string['addcondition'] = 'Inserir condição';
...
$string['addfilehere'] = 'Solte os arquivos aqui para adicioná-los no fim desta seção';
...
$string['adminhelpsitesettings'] = 'Definir aparência da página principal';
...
$string['categoryheader'] = 'Menu de categorias';
...
$string['categorypath'] = 'Caminho de categoria';
...
$string['changesmade'] = 'Alterações realizadas';
...
$string['clear'] = 'Limpar';
$string['clearfilterrow'] = 'Remover linha do filtro';
...
$string['closeblockdrawer'] = 'Fechar gaveta de blocos';
$string['closebuttontitle'] = 'Fechar';
$string['closecourseindex'] = 'Fechar índice do curso';
$string['closedrawer'] = 'Fechar gaveta';
...
$string['cookiesenabled_help'] = 'Dois cookies são utilizados neste site:

O cookie essencial é o cookie de sessão, geralmente chamado MoodleSession. Você deve permitir este cookie no seu navegador para ter continuidade e permanecer logado enquanto navega pelo site. Quando você sai ou fecha o navegador este cookie é destruído (no seu navegador e no servidor).

O outro cookie é apenas para sua conveniência, geralmente chamado de algo como MOODLEID. Ele apenas lembra sua identificação no navegador. Isso significa que quando você retornar a este site, o campo de identificação do usuário na página de autenticação será automaticamente preenchido para você. É seguro recusar este cookie - você apenas terá que redigitar a sua identificação toda vez que você autenticar.';
$string['cookiesenabled_help_html'] = 'Dois cookies são utilizados neste site:<br/><br/>

O cookie essencial é o cookie de sessão, geralmente chamado MoodleSession. Você deve permitir este cookie no seu navegador para ter continuidade e permanecer logado enquanto navega pelo site. Quando você sai ou fecha o navegador este cookie é destruído (no seu navegador e no servidor).<br/><br/>
...
$string['coursecategory_help'] = 'Esta configuração determina a categorial na qual o curso irá aparecer na lista de cursos.';
$string['coursecategorydeleted'] = 'Categoria {$a} de cursos apagada';
...
$string['coursedisplay_help'] = 'Seções do curso podem ser exibidas todas em uma página ou separadas em diversas páginas.';
...
$string['courseheader'] = 'Menu do curso';
...
$string['courseoverviewfiles_help'] = 'A imagem do curso é exibida em "Meus cursos" e na lista de cursos disponíveis da "Página inicial". Os administradores do site podem habilitar tipos de arquivos adicionais e o uso de múltiplos arquivos. Se você usar múltiplos arquivos, eles serão todos exibidos na lista de cursos disponíveis da "Página inicial".';
...
$string['coursereuse'] = 'Reutilizar curso';
...
$string['coursesummary_help'] = 'Uma descrição curta do seu curso. O conteúdo incluído aqui é pesquisável.';
$string['coursetitle'] = 'Curso: {$a->course}';
$string['courseupdates'] = 'Atualizações do curso';
$string['coursevisibility'] = 'Visibilidade do curso';
$string['coursevisibility_help'] = '* Mostrar: O curso aparece na lista de cursos e os participantes podem acessá-lo.
* Ocultar: O acesso é restrito a docentes e demais usuários com a permissão de ver cursos ocultos.';
$string['create'] = 'Criar';
...
$string['defaulthomepageuser_help'] = 'Para qual página você deverá ir após entrar neste site?';
...
$string['emaildisplay'] = 'Visibilidade de e-mail';
$string['emaildisplay_help'] = '* Oculto - Somente usuários com permissões adequadas, como professores, podem visualizar seu endereço de e-mail.
* Visível para todos - Todos os usuários do site podem visualizar seu endereço de e-mail.
* Visível para os participantes do curso - Somente os participantes dos cursos que você está inscrito podem visualizar seu endereço de e-mail.';
$string['emaildisplaycourse'] = 'Visível para os participantes do curso';
$string['emaildisplaycoursemembersonly'] = '(Visível para outros participantes do curso)';
$string['emaildisplayeveryone'] = '(Visível para todos)';
$string['emaildisplayhide'] = '(Oculto de todos, exceto usuários com permissões adequadas)';
...
Um pedido de redefinição de senha foi feito para sua conta \'{$a->username}\' em {$a->sitename}.

Para confirmar esse pedido e definir uma nova senha para sua conta, por favor, acesse o link a seguir:

{$a->link}
(Este link é válido por {$a->resetminutes} minutos, contados do momento em que a redefinição foi solicitada.)

Se a redefinição de senha não foi solicitada por você, nenhuma ação é necessária.

Se precisar de ajuda, entre em contato com o administrador, {$a->admin}';
...
$string['emojicategorypeoplebody'] = 'Pessoas e corpo';
$string['emojicategoryrecent'] = 'Recente';
$string['emojicategorysmileysemotion'] = 'Smileys e emoção';
$string['emojicategorysymbols'] = 'Símbolos';
$string['emojicategorytravelplaces'] = 'Viagens e lugares';
$string['emptycmids'] = 'IDs de módulo de curso vazios';
$string['emptydragdropregion'] = 'região vazia';
$string['emptysectionids'] = 'IDs de seções vazias';
$string['enable'] = 'Habilitar';
$string['encryptedcode'] = 'Código criptografado';
$string['enddate'] = 'Data de término do curso';
$string['enddate_help'] = 'A data de término do curso é usada para determinar se um curso não deve mais listado na visão geral e ser listado como encerrado no resumo de cursos. A data de término do curso também pode ser usada para relatórios personalizados. Usuários ainda podem acessar o curso depois da data de término; em outras palavras, a data não restringe o acesso.';
...
$string['eventmycoursesviewed'] = 'Meus cursos vistos';
...
$string['filtersetmatchdescription'] = 'Como filtros múltiplos devem ser combinados';
$string['filtertype'] = 'Tipo do filtro';
...
$string['frontpageformatloggedin'] = 'Formato da página principal depois do login';
...
$string['fullnamecourse_help'] = 'O nome mostrado em Meus cursos e na lista de cursos disponíveis na página inicial.';
...
$string['grade'] = 'Nota';
$string['gradenoun'] = 'Nota';
$string['grades'] = 'Notas';
$string['gradeverb'] = 'Nota';
...
$string['hiddensections_help'] = '<P>Estas opções permitem que você decida como seções ocultas no seu curso serão mostradas para os estudantes.</p>

<p>A opção padrão "Seções ocultas são mostradas como indisponíveis" define que as seções ficam visíveis aos estudantes, mas com a cor alterada e sem acesso aos seus conteúdos (atividades e recursos). Isto pode ser útil em cursos com o formato semanal, para indicar semanas de férias, por exemplo.
</p>

<p>Se você escolher a outra opção, "Seções ocultas são completamente invisíveis", as seções não serão mostradas enquanto estiverem ocultas.
</p>';
$string['hiddensectionscollapsed'] = 'Seções ocultas são mostradas como indisponíveis';
...
$string['hidefromstudents'] = 'Ocultar na página do curso';
...
$string['idnumbermod_help'] = 'Definir um número de ID ajuda a identificar a atividade ou recursos para propósitos como cálculo de notas ou relatórios personalizados. Caso contrário pode ficar em branco.
...
$string['indicator:potentialcognitivedef_link'] = 'Indicadores_de_aprendizado_para_análises#Profundidade_cognitiva';
...
$string['indicator:potentialsocialdef_link'] = 'Indicadores_de_aprendizado_para_análises#Abrangência_social';
...
$string['loginagain'] = 'Fazer log in novamente';
...
$string['managecategories'] = 'Gerenciar categorias de cursos';
$string['managecategorythis'] = 'Gerenciar esta categoria';
$string['managecombined'] = 'Gerenciar cursos e categorias de cursos';
...
$string['matchofthefollowing'] = 'aos seguintes:';
...
$string['maximumupload_help'] = 'O tamanho máximo permitido para os arquivos que os estudantes enviam para o curso. Além disso, você pode restringir ainda mais o tamanho máximo de upload para cada atividade.';
...
$string['messageprovider:coursecontentupdated'] = 'Mudanças no conteúdo do curso';
...
$string['messageprovider:newlogin'] = 'Notificações de novos acessos';
...
$string['messageprovider:reportbuilderschedule'] = 'Agendamentos do construtor de relatórios personalizados';
...
$string['missinglastname'] = 'Sobrenome ausente';
...
$string['modvisible_help'] = '* Mostrar na página do curso: Disponível para estudantes (sujeito a quaisquer restrições de acesso que possam ser definidas).
* Ocultar na página do curso: Não disponível para estudantes.';
$string['modvisiblehiddensection'] = 'Disponibilidade';
$string['modvisiblehiddensection_help'] = '* Ocultar na página do curso: Não disponível para estudantes.
* Disponibilizar, mas não mostrar na página do curso: Disponível para os estudantes se você fornecer um link. As atividades ainda aparecerão no livro de notas e em outros relatórios.';
$string['modvisiblewithstealth'] = 'Disponibilidade';
$string['modvisiblewithstealth_help'] = '* Mostrar na página do curso: Disponível para estudantes (sujeito a quaisquer restrições de acesso que possam ser definidas).
* Ocultar na página do curso: Não disponível para estudantes.
* Disponibilizar, mas não mostrar na página do curso: Disponível para os estudantes se você fornecer um link. As atividades ainda aparecerão no livro de notas e em outros relatórios.';
$string['month'] = 'Mês';
$string['months'] = 'Meses';
...
<p>Sua conta em {$a->sitename} acabou de ser acessada em em um novo dispositivo.</p>
<ul>
<li>Sua conta: {$a->username} {$a->useremail}</li>
<li>{$a->logintime}</li>
<li>Dispositivo: {$a->logindevice}</li>
<li>IP: {$a->loginip}</li>
</ul>
<p>Caso tenha sido você mesmo, não é necessário realizar nenhuma ação.</p>
<p>Caso você não reconheça esta atividade, por favor <a href="{$a->changepasswordlink}">altere sua senha</a></p>';
$string['newloginnotificationbodysmall'] = 'Sua conta em {$a} acabou de ser acessada em outro dispositivo.';
$string['newloginnotificationtitle'] = 'Novo acesso a sua conta em {$a}';
...
$string['newsitemsnumber_help'] = 'O fórum de avisos tem a assinatura forçada por padrão. Apenas professores e outros usuários com permissões apropriadas podem postar nele.

Se você não precisa de um fórum de avisos, defina isso como zero.

Essa configuração também determina quantos avisos recentes aparecerão no bloco de últimas notícias.';
...
$string['opendrawerblocks'] = 'Abrir gaveta de blocos';
$string['opendrawerindex'] = 'Abrir índice do curso';
$string['opensinnewwindow'] = 'Abrir em uma nova janela';
...
$string['selectgroupsseparate'] = 'Selecionar grupos separados';
$string['selectgroupsvisible'] = 'Selecionar grupos visíveis';
...
$string['setmode'] = 'Configurar modo';
...
$string['shortnamecourse_help'] = 'O nome exibido em áreas com espaço limitado. Deve ser único.';
...
$string['showactivitydates'] = 'Mostrar as datas da atividade';
$string['showactivitydates_help'] = 'Mostrar as datas das atividades na página do curso.';
...
$string['showgrades_help'] = 'Permitir que os participantes vejam uma lista com todas as suas notas obtidas no curso.';
...
$string['showreports_help'] = 'Permitir que os participantes vejam seus próprios relatórios de atividades na página de perfil.';
...
$string['startdate_help'] = 'Essa data determina o início da primeira semana de um curso em formato semanal. Ela também é a data inicial dos registros (logs) de atividades do curso.

Se você reiniciar o curso e alterar essa data, todas as datas do curso serão alteradas com base na nova data de início.';
...
$string['unexistingcmid'] = 'ID do módulo do curso não encontrado';
$string['unexistingsectionid'] = 'ID da seção do curso não encontrado';
...
$string['usermenugoback'] = 'Voltar ao menu do usuário';
$string['username'] = 'Identificação de usuário';
$string['usernameemail'] = 'Identificação ou email';
...
$string['wcagcheck'] = 'Verificar as Diretrizes de Acessibilidade de Conteúdo da Web (WCAG)';
...
$string['welcomeback'] = 'Bem-vindo(a) de volta, {$a->firstname}! 👋';
$string['welcometocourse'] = 'Bem-vindo(a) ao {$a}';
