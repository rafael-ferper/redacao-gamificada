...
/**
 * Strings for component 'block_simple_clock', language 'pt_br', version '4.1'.
 *
...
$string['config_day_help'] = '<p> Mostrando o nome do dia acrescenta informação adicional para os estudantes que podem estar em um fuso horário de um dia mais cedo ou mais tarde. </p>';
...
Se selecionar a opção "Não", os estudantes não irão ver o cabeçalho, independentemente de a "Edição" estar ativada ou desativada.</p>';
