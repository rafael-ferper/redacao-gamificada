...
/**
 * Strings for component 'editor_tinymce', language 'pt_br', version '4.1'.
 *
...
$string['advlink_dlg:is_email'] = 'O URL digitado parece ser um endereço de e-mail. Deseja acrescentar o prefixo necessário mailto:?';
...
$string['autosave:warning_message'] = 'Se restaurar o conteúdo salvo, você irá perder o todo o conteúdo que está atualmente no editor.
...
$string['pluginname'] = 'Editor de HTML TinyMCE (legado)';
$string['preview:preview_desc'] = 'Pré-visualizar';
$string['print:print_desc'] = 'Imprimir';
$string['privacy:metadata'] = 'O plugin do editor HTML do TinyMCE não armazena nenhum dado pessoal.';
...
$string['style_dlg:text_overline'] = 'Linha acima';
...
$string['table_dlg:cellpadding'] = 'Espaçamento interno da célula';
