...
/**
 * Strings for component 'repository_flickr', language 'pt_br', version '4.1'.
 *
...
$string['privacy:metadata:repository_flickr'] = 'O plugin de repositório Flickr armazena as preferências do usuário e transmite os dados do usuário do Moodle para o sistema remoto.';
$string['privacy:metadata:repository_flickr:preference:repository_flickr_access_token'] = 'A preferência do token OAuth do repositório do Flickr.';
$string['privacy:metadata:repository_flickr:text'] = '';
