...
/**
 * Strings for component 'backup', language 'pt_br', version '4.1'.
 *
 * @package     backup
 * @category    string
...
$string['backupautoactivitiesdescription'] = 'Definir o padrão para inclusão de atividades em um backup. Para que a lixeira funcione, esta configuração deve estar habilitada.';
...
$string['questioncannotberestored'] = 'As questões "{$a->name}" não puderam ser criadas pela restauração';
...
$string['restoreexecutionsuccess'] = 'O curso foi restaurado com sucesso.';
...
$string['sitecourseformatwarning'] = 'Esta é um backup da página principal. Observe que ele só pode ser restaurado na página principal do site.';
