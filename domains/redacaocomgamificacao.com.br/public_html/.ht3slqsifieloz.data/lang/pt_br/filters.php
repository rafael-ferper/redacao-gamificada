...
/**
 * Strings for component 'filters', language 'pt_br', version '4.1'.
 *
 * @package     filters
 * @category    string
...
$string['anycourses'] = 'Inscrito em qualquer curso';
...
$string['coursevalue'] = 'valor no curso';
...
$string['privacy:reason'] = 'O subsistema Filtro não armazena dados pessoais.';
$string['profilefilterfield'] = 'Nome do campo perfil';
$string['profilefilterlimiter'] = 'Operador do campo do perfil';
