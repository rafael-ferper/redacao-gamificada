...
/**
 * Strings for component 'gradingform_guide', language 'pt_br', version '4.1'.
 *
...
$string['additionalcommentsforcriterion'] = 'Comentários adicionais para critério, {$a}';
...
$string['informationforcriterion'] = '{$a} informações';
...
$string['outof'] = 'Pontuação de {$a}';
$string['pluginname'] = 'Guia de avaliação';
$string['previewmarkingguide'] = 'Guia de avaliação anterior';
$string['privacy:metadata:fillingssummary'] = 'Armazena informações sobre a nota e o feedback de um usuário para o guia de avaliação.';
...
$string['remark_help'] = 'Digite comentários adicionais sobre esse critério.';
