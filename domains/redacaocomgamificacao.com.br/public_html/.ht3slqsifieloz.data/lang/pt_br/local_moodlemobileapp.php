...
$string['addon.storagemanager.storageused'] = 'Armazenamento de arquivos usado:';
...
$string['core.course.activitynotyetviewablesiteupgradeneeded'] = 'A instalação Moodle da sua organização precisa ser atualizada.';
$string['core.course.allsections'] = 'Todas as seções';
$string['core.course.aria:sectionprogress'] = 'Progresso da seção:';
$string['core.course.askadmintosupport'] = 'Entre em contato com o administrador do site e diga que deseja usar esta atividade com o aplicativo Moodle Mobile.';
...
$string['core.course.confirmdeletemodulefiles'] = 'Tem certeza de que deseja excluir esses arquivos?';
$string['core.course.confirmdeletestoreddata'] = 'Tem certeza de que deseja excluir os dados armazenados?';
...
$string['core.login.faqcantloginanswer'] = '<p>Depois de se conectar ao seu site Moodle, você poderá fazer login com seu nome de usuário e senha habituais.</p><br><p>Se você esqueceu seu nome de usuário ou senha, selecione a opção <strong >Esqueceu seu nome de usuário ou senha?</strong>. Se você ainda tiver problemas para fazer login ou não conseguir ver nenhuma opção para recuperar seu nome de usuário ou senha, entre em contato com ao suporte do Moodle em sua escola ou instituição de ensino.</p>';
...
$string['core.login.localmobileunexpectedresponse'] = 'A verificação de recursos adicionais do Moodle Mobile retornou uma resposta inesperada. Você será autenticado usando o serviço móvel padrão.';
...
$string['core.login.reconnectdescription'] = 'Sua sessão expirou. Faça login novamente para continuar.';
...
$string['core.settings.deletesitefiles'] = 'Tem certeza de que deseja excluir os arquivos baixados e os dados em cache do site \'{{sitename}}\'? Você não poderá usar o aplicativo no modo offline.';
$string['core.settings.deletesitefilestitle'] = 'Excluir arquivos do site';
...
$string['core.settings.errordeletesitefiles'] = 'Erro ao excluir arquivos do site.';
...
$string['core.settings.spaceusagehelp'] = 'Excluir as informações armazenadas do site removerá todos os dados offline do site. Estas informações permitem que você use o aplicativo quando estiver offline.';
