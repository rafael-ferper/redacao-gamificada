...
/**
 * Strings for component 'error', language 'pt_br', version '4.1'.
 *
 * @package     error
 * @category    string
...
$string['agedigitalconsentmapinvalidcomma'] = '"{$a}" tem mais ou menos de um separador de vírgula.';
$string['agedigitalconsentmapinvalidcountry'] = '"{$a}" não é um valor válido para o país.';
$string['agedigitalconsentmapinvaliddefault'] = 'O valor padrão (*) está faltando.';
...
$string['cannotdisableformat'] = 'Você não pode desabilitar o formato padrão';
...
$string['cannotfindlang'] = 'Não foi encontrado o pacote do idioma "{$a}"!';
...
$string['cannotopenzip'] = 'Não é possível abrir o arquivo compactado, provavelmente problema com a extensão do arquivo em sistema operacional de 64 bits';
...
$string['cannotservefile'] = 'Não foi possível acessar o arquivo devido a um problema na configuração do servidor.';
...
$string['cannotviewcategory'] = 'Você não tem permissão para ver a lista de cursos.';
...
$string['contenttypenotfound'] = 'O tipo de banco de conteúdo \'{$a}\' não existe ou não é reconhecido.';
...
$string['couldnotverifyagedigitalconsent'] = 'Ocorreu um erro ao tentar verificar a idade do consentimento digital. <br/> Por favor, entre em contato com o administrador.';
...
$string['courseformatnotfound'] = 'O formato de curso \'{$a}\' não existe ou não foi reconhecido.';
$string['coursegroupunknown'] = 'O curso correspondente ao grupo {$a} não foi definido';
$string['courseidnotfound'] = 'O ID do curso não existe.';
...
$string['csvfileerror'] = 'Há algo errado com o formato do arquivo CSV. Verifique se o número de títulos e colunas correspondem e se o delimitador e a codificação do arquivo estão corretos: {$a}';
...
$string['csvnodata'] = 'Arquivo CSV inválido - O arquivo CSV tem cabeçalhos, mas não contém dados.';
...
$string['dbsessionmysqlpacketsize'] = 'foram detectados sérios problemas de sessão. Por favor notificar o administrador do site. A causa mais provável deste problema é um valor baixo para max_allowed_packet na configuração do MySQL.';
...
$string['detectedbrokenplugin'] = 'O plugin {$a} está com defeito ou desatualizado; você não pode continuar, desculpe.';
...
$string['encryption_decryptfailed'] = 'A desencriptação falhou';
$string['encryption_encryptfailed'] = 'A criptografia falhou';
$string['encryption_invalidkey'] = 'Chave inválida';
$string['encryption_keyalreadyexists'] = 'Chave já existe';
...
$string['errorfetchingrssfeed'] = 'Erro no acesso ao alimentador de notícias RSS.';
$string['erroronline'] = 'Erro na linha {$a}';
$string['erroroutput'] = 'Erro de saída (output), redirecionamento automático desabilitado.';
...
$string['functionalityremoved'] = 'Você está tentando acessar uma funcionalidade que foi removida.';
...
$string['idnumbertaken'] = 'Este número ID já está em uso';
...
$string['invalidcoursemoduleid'] = 'ID do módulo do curso inválido: {$a}';
...
$string['invalidgradeitemid'] = 'ID de Item de avaliação incorreto';
$string['invalidgroupid'] = 'ID de grupo incorreto';
...
$string['invalidrecord'] = 'Não foi encontrada nenhum registro na tabela  {$a} do banco de dados.';
$string['invalidrecordunknown'] = 'Não foi encontrada nenhum registro no banco de dados.';
...
$string['invalidshortname'] = 'Nome breve de curso inválido';
...
$string['invalidusernameblank'] = 'O nome de usuário não pode ficar em branco';
...
$string['listcantmovedown'] = 'Impossível mover o item para baixo, pois ele está no final da lista.';
...
$string['listcantmoveup'] = 'Impossível mover o item para cima, pois ele é o primeiro da lista.';
...
$string['maxdraftitemids'] = 'Os uploads de seus arquivos estão temporariamente limitados depois que você carrega um grande volume de arquivos. Aguarde e tente novamente.';
$string['messageundeliveredbynotificationsettings'] = 'A mensagem não pôde ser enviada porque as mensagens pessoais entre usuários (nas configurações de Notificação) foram desabilitadas por um administrador do site.';
$string['messagingdisable'] = 'As mensagens não estão habilitadas nesta instalação';
$string['mimetexisnotexist'] = 'Seu sistema não está configurado para executar mimeTex. Você precisa obter o código fonte C em <a href="https://www.forkosh.com/mimetex.zip">https://www.forkosh.com/mimetex.zip</a>, compilar e colocar o executável dentro do diretório filter/tex do seu moodle.';
...
$string['missingcategoryrole'] = 'Não foi possível atribuir o papel ao usuário: papel ausente para a categoria.';
...
$string['mixedtypesqlparam'] = 'ERRO: Tipos de parâmetros misturados na consulta SQL!!';
...
$string['movecatcontentstoselected'] = 'Parte do conteúdo da categoria não pode ser movido para a categoria selecionada.';
...
$string['mssqlrcsmodemissing'] = 'O banco de dados não está usando o modo esperado READ_COMMITTED_SNAPSHOT que pode levar a resultados errados, especialmente em cenários de alta concorrência. Ative-o para o comportamento correto. Você pode encontrar mais informações na documentação <a href="https://docs.moodle.org/en/Installing_MSSQL_for_PHP">Installing MSSQL for PHP</a>.';
...
$string['nopermissions'] = 'Desculpe, mas atualmente você não tem permissão para {$a}';
$string['nopermissiontoaccesspage'] = 'Você não tem permissão para acessar esta página.';
$string['nopermissiontocomment'] = 'Você não pode adicionar comentários';
$string['nopermissiontodelentry'] = 'Você não pode excluir este comentário!';
...
$string['nopermissiontoviewcalendar'] = 'Desculpe, você não tem permissão para ver o evento do calendário.';
...
$string['notavailable'] = 'Não está disponível no momento';
...
$string['oauth2refreshtokenerror'] = 'Não foi possível atualizar o token OAuth 2. Status HTTP para endpoint remoto: {$a}';
$string['oauth2refreshtokentaskerror'] = 'Não foi possível atualizar o token OAuth 2 para um ou mais emissores. Veja a saída da tarefa para obter detalhes.';
$string['oauth2upgradetokenerror'] = 'Não foi possível atualizar o token OAuth 2. Status HTTP para endpoint remoto: {$a}';
...
$string['opensslsignerror'] = 'OpenSSL incapaz de assinar dados';
$string['orderidnotfound'] = 'ID do pedido {$a} não encontrado';
$string['pagenotexist'] = '<p>Aconteceu um erro incomum ao tentar visualizar uma página que não existe:</p>{$a}';
$string['pagenotexisttitle'] = 'Erro 404: Arquivo não encontrado';
...
$string['pluginunsupported'] = 'O plugin "{$a->pluginname}" {$a-> pluginversion} não suporta esta versão do Moodle {$a->moodleversion}. Procure informações sobre este plugin para encontrar versões suportadas.';
...
$string['restricteduser'] = 'Desculpe, mas a sua conta atual, "{$a}" , não tem permissão para fazer isto.';
...
$string['sendmessagesent'] = 'Obrigado por seus comentários sobre: <br> {$a}';
$string['serverconnection'] = 'Erro ao conectar ao servidor';
$string['servicedonotexist'] = 'Este serviço não existe';
$string['sessioncannotobtainlock'] = '<p>Não foi possível obter o bloqueio para a sessão id {$a->id} dentro de {$a->acquiretimeout}.</p>
<p>É provável que outra página ({$a->whohaslock}) ainda esteja em execução em outra guia do navegador ou o bloqueio não foi liberado devido a um erro.</p>
<p>Você pode esperar até o tempo limite de bloqueio da sessão ({$a->lockexpire}) ou reiniciar a sessão do navegador. Se o erro persistir, notifique o administrador do servidor.</p>';
...
$string['storedfilecannotcreatefile'] = 'Não é possível criar o arquivo. Por favor, verifique as permissões no dataroot e o espaço em disco disponível.';
$string['storedfilecannotcreatefiledirs'] = 'Impossível criar o diretório para arquivos. Por favor, verifique as permissões no dataroot.';
...
$string['tagdisabled'] = 'As tags estão desabilitadas!';
$string['tagnotfound'] = 'A tag especificada não foi encontrada no banco de dados';
...
$string['unknowncategory'] = 'Categoria desconhecida com número de ID de categoria "{$a}"';
...
$string['userisfilteredout'] = 'Este usuário não corresponde aos filtros e preferências de tabela!';
$string['usermustbemnet'] = 'Os usuários na lista de controle de acesso MNET devem ser usuários MNET remotos';
$string['usernamelowercase'] = 'O nome de usuário deve estar em minúsculas';
...
$string['verifyagedigitalconsentnotpossible'] = 'Desculpe, a verificação digital da idade de consentimento não é possível no momento.';
