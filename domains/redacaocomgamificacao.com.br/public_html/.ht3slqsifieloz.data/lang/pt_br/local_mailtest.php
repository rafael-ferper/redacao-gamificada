...
/**
 * Strings for component 'local_mailtest', language 'pt_br', version '4.1'.
 *
...
$string['divertallemails'] = 'Redirecionar todos os e-mails';
$string['divertedto'] = 'Redirecionado para {$a}';
...
$string['noemailever'] = '<p>O email neste site foi desativado por meio de <strong>$CFG-&gt;noemailever = true;</strong>.</p>';
$string['nologavailable'] = '<p>O registro de logs não está disponível ao usar a função mail() do PHP. No entanto, pode encontrar logs em seu servidor. Os locais mais comuns no Linux são:</p>
<ul>
...
<p>Alernativamente, um local personalizado pode ser especificado usando a configuração mail.log em php.ini.</p>';
...
$string['privacy:metadata'] = 'O plugin de teste de email não armazena nenhum dado pessoal de nenhum usuário.';
...
$string['winsyslog'] = 'Registro de eventos no Windows';
