...
/**
 * Strings for component 'message_airnotifier', language 'pt_br', version '4.1'.
 *
...
$string['donotsendnotification'] = 'Não enviar notificações de forma alguma';
$string['enableprocessor'] = 'Habilitar notificações móveis';
$string['encryptnotifications'] = 'Criptografar notificações';
$string['encryptnotifications_help'] = 'Habilitar a criptografia de ponta a ponta das notificações do aplicativo sempre que possível. Apenas dados pessoais são criptografados, alguns dados podem ser removidos da carga de notificação se não puderem ser criptografados.';
$string['encryptprocessing'] = 'Para dispositivos que não suportam criptografia';
$string['encryptprocessing_desc'] = 'Indicar o que fazer quando o dispositivo de destino não oferece suporte à criptografia (compatível apenas com Android 6 e iOS 13 em diante).';
...
$string['noemailevernotset'] = '$CFG->noemailever desabilitado';
$string['noemaileverset'] = '$CFG->noemailever está habilitada no config.php. Você precisa definir esta configuração para false ou removê-la.';
...
$string['sendnotificationnotenc'] = 'Enviar notificações sem criptografia';
