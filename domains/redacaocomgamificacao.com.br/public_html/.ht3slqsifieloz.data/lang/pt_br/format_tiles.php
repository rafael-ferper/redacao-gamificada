...
$string['basecolour_help'] = 'A cor definida aqui será aplicada a todas os blocos do curso. (As cores disponíveis são definidas pelo administrador do seu site através da página de configurações do plugin Blocos).';
...
$string['editoradvicesubtiles'] = 'Nesta versão do plugin Blocos, as atividades só aparecerão como sub-blocos se o modo de edição estiver desativado';
...
$string['notregistered'] = 'Seu plugin Blocos ainda não está registrado no site do desenvolvedor do plugin.';
...
$string['registeremailyes'] = 'Sim, pretendo receber notificações ocasionais de atualizações e outras informações sobre o plugin Blocos';
...
$string['settings'] = 'Configurações do formato Blocos';
$string['show'] = 'Mostrar';
...
$string['tilesformatregistration'] = 'Registro do formato Blocos';
$string['tip'] = 'Ajuda';
