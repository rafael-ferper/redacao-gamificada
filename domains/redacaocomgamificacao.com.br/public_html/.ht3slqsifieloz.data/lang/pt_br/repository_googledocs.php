...
/**
 * Strings for component 'repository_googledocs', language 'pt_br', version '4.1'.
 *
...
$string['docsformat'] = 'Formato padrão de importação de documento';
$string['drawingformat'] = 'Formato padrão de importação de desenho';
...
$string['importformat'] = 'Configurar o padrão dos formatos de importação do Google';
...
$string['presentationformat'] = 'Formato padrão de importação de apresentação';
$string['privacy:metadata:repository_googledocs'] = 'O plugin de repositório Google Drive não armazena nenhum dado pessoal, mas transmite os dados do usuário do Moodle para o sistema remoto.';
$string['privacy:metadata:repository_googledocs:email'] = 'O email do usuário do repositório do Google Drive.';
...
$string['shareddrives'] = 'Drives compartilhados';
$string['spreadsheetformat'] = 'Formato padrão de importação de planilha';
