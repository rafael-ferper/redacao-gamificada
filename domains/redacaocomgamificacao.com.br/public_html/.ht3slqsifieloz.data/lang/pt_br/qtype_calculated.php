...
/**
 * Strings for component 'qtype_calculated', language 'pt_br', version '4.1'.
 *
...
$string['nocoherencequestionsdatyasetcategory'] = 'Para a identificação de questão {$a->qid}, a identificação da categoria {$a->qcat} não é identica com o curinga compartilhado {$a->name} com a identificação da categoria {$a->sharedcat}. Editar a questão.';
...
$string['pluginnameediting'] = 'Editando uma questão calculada';
$string['pluginnamesummary'] = 'As Questões calculadas são como questões numéricas, mas com os números utilizados selecionados aleatoriamente a partir de um conjunto quando o questionário é preenchido.';
$string['possiblehdr'] = 'Possíveis caracteres curingas presentes somente no texto da questão';
$string['privacy:metadata'] = 'O plugin de tipo de questão Calculada não armazena nenhum dado pessoal.';
$string['questiondatasets'] = 'Conjunto de dados de questão';
$string['questiondatasets_help'] = 'Conjunto de dados de questão de curingas que serão utilizados em cada questão individual.';
$string['questionstoredname'] = 'Nome armazenado da questão';
...
$string['youmustaddatleastoneitem'] = 'Vocè precisa adicionar, ao menos, um conjunto de dados antes de gravar esta questão.';
$string['youmustaddatleastonevalue'] = 'Vocè precisa adicionar, ao menos, um conjunto de curinga antes de gravar esta questão.';
