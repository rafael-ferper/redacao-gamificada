...
/**
 * Strings for component 'role', language 'pt_br', version '4.1'.
 *
 * @package     role
 * @category    string
...
$string['contextrolenotallowed'] = 'O papel {$a} não é permitido neste contexto.';
...
$string['course:setforcedlanguage'] = 'Forçar idioma do curso ou atividade';
...
$string['frontpageuserdescription'] = 'Todos os usuários logados no curso da página inicial.';
$string['globalrole'] = 'Papel global do sistema';
$string['globalroleswarning'] = 'Aviso: todos os papeis que você atribuir nesta página serão aplicadas aos usuários em todo o sistema, incluindo a página inicial do site e todos os cursos.';
...
$string['privacy:metadata:role_capabilities:tableexplanation'] = 'As permissões e as substituições de permissões para um papel específico em um contexto específico';
$string['privacy:metadata:role_capabilities:timemodified'] = 'A data em que a capacidade foi criada ou modificada.';
...
$string['question:commentall'] = 'Comentar em todas as questões';
$string['question:commentmine'] = 'Comentar as suas próprias questões';
...
$string['reportbuilder:edit'] = 'Editar seus próprios relatórios personalizados';
$string['reportbuilder:editall'] = 'Editar todos relatórios personalizados';
$string['reportbuilder:scheduleviewas'] = 'Relatórios agendados serão visualizados como outros usuários';
