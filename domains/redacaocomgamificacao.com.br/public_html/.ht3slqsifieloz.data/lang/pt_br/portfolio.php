...
/**
 * Strings for component 'portfolio', language 'pt_br', version '4.1'.
 *
 * @package     portfolio
 * @category    string
...
$string['moderatefilesizethreshold'] = 'Tamanho moderado de arquivo';
...
$string['privacy:metadata'] = 'O subsistema de portfólio atua como um canal, passando requisições dos plugins para os vários plugins de portfólio.';
$string['privacy:metadata:instance'] = 'Identificador do Portifólio';
$string['privacy:metadata:instancesummary'] = 'Armazena dados sobre instâncias e preferências do portfólio.';
$string['privacy:metadata:name'] = 'Nome preferido';
$string['privacy:metadata:portfolio_log'] = 'Log de transferências de portfólio (usado para verificar posteriormente se há duplicidade)';
$string['privacy:metadata:portfolio_log:caller_class'] = 'Nome da classe usada para criar a transferência';
$string['privacy:metadata:portfolio_log:caller_component'] = 'Nome do componente responsável pela exportação';
$string['privacy:metadata:portfolio_log:time'] = 'Hora da transferência (no caso de uma transferência na fila, é a hora em que a transferência real foi executada, não quando o usuário a iniciou)';
$string['privacy:metadata:portfolio_log:userid'] = 'ID do usuário que exportou conteúdo';
$string['privacy:metadata:portfolio_tempdata'] = 'Armazena dados temporários para exportações de portfólio.';
$string['privacy:metadata:portfolio_tempdata:data'] = 'Exportar dados';
$string['privacy:metadata:portfolio_tempdata:expirytime'] = 'Horário em que esse registro expira';
$string['privacy:metadata:portfolio_tempdata:instance'] = 'Instância do plugin do portfólio sendo usada';
$string['privacy:metadata:portfolio_tempdata:userid'] = 'Usuário realizando exportação';
$string['privacy:metadata:userid'] = 'ID do usuário';
$string['privacy:metadata:value'] = 'Valor para a preferência';
$string['privacy:path'] = 'Instâncias do portfólio';
