...
/**
 * Strings for component 'lesson', language 'pt_br', version '4.1'.
 *
 * @package     lesson
 * @category    string
...
$string['emailsuccess'] = 'Os emails foram enviados com sucesso';
...
$string['essayemailmessagesmall'] = '<p>Você recebeu {$a->earned} de {$a->outof} para esta questão dissertativo.</p><p>Sua nota para a lição {$a-> lesson} foi alterada para {$a->newgrade}%.</p>';
...
$string['indicator:cognitivedepthdef_help'] = 'O participante atingiu esta porcentagem de engajamento cognitivo oferecido pelas atividades de Lição durante este intervalo de análise (Níveis = Sem visualizar, Ver, Enviar, Ver feedback, Comentar sobre o feedback, Reenviar após ver o feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Indicador social da Lição';
$string['indicator:socialbreadth_help'] = 'Este indicador é baseado na amplitude social alcançada pelo estudante em uma atividade Lição.';
...
$string['maximumnumberofanswersbranches_help'] = 'Essa configuração especifica o número máximo de respostas que podem ser usadas na lição. Se forem usadas apenas perguntas de verdadeiro ou falso , ela poderá ser definida como 2. A configuração poderá ser alterada a qualquer momento, pois afeta apenas o que o professor vê, não os dados.';
