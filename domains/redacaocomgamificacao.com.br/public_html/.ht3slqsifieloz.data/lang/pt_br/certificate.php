...
/**
 * Strings for component 'certificate', language 'pt_br', version '4.1'.
 *
 * @package     certificate
 * @category    string
...
$string['emailothers_help'] = 'Insira aqui os endereços de e-mails, separados por vírgula, daqueles que devem ser alertados com um e-mail sempre que estudantes receberem um certificado.';
...
$string['emailteachers_help'] = 'Se ativado, os professores receberão um e-mail sempre que os estudantes receberem um certificado.';
...
$string['reissuecert'] = 'Reemissão de Certificados';
$string['reissuecert_help'] = 'Se você escolher sim aqui, este certificado será reemitido com uma nova data, série e número de código toda vez que um usuário clicar no link do certificado. Observação: embora uma tabela mostre as datas de recebimento anteriores, nenhum botão de revisão estará disponível para os usuários. Somente o último certificado emitido aparecerá no relatório do certificado.';
...
$string['summaryofattempts'] = 'Resumo de certificados recebidos anteriormente';
