...
/**
 * Strings for component 'openmeetings', language 'pt_br', version '4.1'.
 *
...
$string['Allow_RecordingDesc'] = 'Configuração global para ativar/desativar gravações';
...
$string['Conference'] = 'Conferência (máx. 16 participantes)';
...
$string['Recording_TYPE_2'] = 'A funcionalidade da gravação não está disponível.';
$string['Restricted'] = 'Webinar (máx. 150 participantes)';
...
$string['url'] = 'URL OpenMeetings';
$string['urlDesc'] = 'URL completa para a sua instância OpenMeetings';
