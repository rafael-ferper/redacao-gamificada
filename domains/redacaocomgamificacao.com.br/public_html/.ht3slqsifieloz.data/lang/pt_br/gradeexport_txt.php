...
/**
 * Strings for component 'gradeexport_txt', language 'pt_br', version '4.1'.
 *
...
$string['privacy:metadata'] = 'O plugin de exportação de notas para arquivo de texto simples não armazena nenhum dado pessoal.';
