...
/**
 * Strings for component 'enrol_authorize', language 'pt_br', version '4.1'.
 *
...
e o estudante será inscrito no curso, em caso contrário expira em {$a->expireon} e não pode ser capturado em data posterior.
Você também pode aceitar ou recusar o pagamento e inscrever o estudante imediatamente seguindo este link :
{$a->url}';
...
$string['captureyes'] = 'O cartão de crédito vai ser capturado e o estudante vai ser inscrito no curso. Proceder?';
...
$string['unenrolstudent'] = 'Desinscrever estudante?';
