...
/**
 * Strings for component 'auth_mnet', language 'pt_br', version '4.1'.
 *
 * @package     auth_mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:lastnamephonetic'] = 'Os detalhes fonéticos do sobrenome do usuário.';
