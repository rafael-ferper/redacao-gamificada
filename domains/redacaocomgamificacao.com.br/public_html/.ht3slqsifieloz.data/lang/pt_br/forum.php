...
/**
 * Strings for component 'forum', language 'pt_br', version '4.1'.
 *
 * @package     forum
 * @category    string
...
$string['addanewdiscussion'] = 'Adicionar tópico de discussão';
...
$string['cannotsplit'] = 'As discussões deste fórum não podem ser separadas';
...
$string['cannotuseseperategroupsandsingletopic'] = 'Grupos separados não podem ser usados com uma única discussão simples.';
$string['cannotusesingletopicandseperategroups'] = 'Uma única discussão simples não pode ser usada com grupos separados.';
$string['cannotviewpostyet'] = 'Você ainda não pode ler as postagens de outros estudantes nesta discussão porque porque você ainda não postou nada.';
...
$string['configlongpost'] = 'Qualquer postagem com esse comprimento (em caracteres que não incluam HTML) é considerada longa. As postagens exibidas na página inicial do site, nas páginas do curso em formato social ou nos perfis de usuário são encurtadas para uma quebra natural em algum lugar entre os valores forum_shortpost e forum_longpost.';
...
$string['discussionnowsubscribed'] = 'Você será notificado sobre novos posts em \'{$a->discussion}\' no fórum \'{$a->forum}\'';
...
$string['discussionsplit'] = 'Discussão foi separada';
...
$string['edit'] = 'Editar';
$string['editdiscussion'] = 'Editar discussão';
...
$string['errordiscussionnotfound'] = 'A discussão não foi encontrada';
...
$string['errorforumnotfound'] = 'O fórum ao qual essa discussão pertence não foi encontrado';
...
* Fórum de perguntas e repostas - O estudante deve postar primeiro antes de ver as publicações dos outros estudantes;
...
$string['nowsubscribed'] = 'Você será notificado sobre novas mensagens no fórum  \'{$a->forum}\' .';
...
$string['postisprivatereply'] = 'Esta é uma resposta privada. (Somente professores e outros usuários com a permissão de visualizar respostas privadas podem vê-la.)';
...
$string['postsmadeincourse'] = 'Publicações feitas em {$a}';
...
$string['prunediscussion'] = 'Separar discussão';
$string['prunedpost'] = 'Foi criada uma nova discussão com esta mensagem inicial';
$string['pruneheading'] = 'Separar a discussão e mover este post para uma nova discussão';
$string['qandaforum'] = 'Fórum P e R (perguntas e respostas)';
$string['qandanotify'] = 'Este é um fórum de perguntas e respostas. Para ver outras respostas, você deve primeiro postar sua resposta.';
$string['re'] = 'Re:';
...
$string['replypostdiscussion'] = 'Responder à discussão';
...
$string['subscriptionmodeconfirm'] = 'Você tem certeza que quer mudar o modo de assinatura para "{$a}"';
...
Se configurado como opcional, os participantes podem escolher se desejam ativar ou desativar o monitoramento através de um fórum. (Os usuários também devem ativar o monitoramento do fórum em suas preferências de fórum).

Se \'Permitir monitoramento de leitura forçado\' estiver habilitado na administração do site, uma outra opção fica disponível - forçado. Isso significa que o monitoramento será sempre ativado, independentemente das preferências de fórum dos usuários.';
...
$string['unsubscribe'] = 'Cancelar assinatura deste fórum';
