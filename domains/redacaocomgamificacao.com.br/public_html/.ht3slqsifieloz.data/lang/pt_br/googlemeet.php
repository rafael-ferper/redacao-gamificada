...
/**
 * Strings for component 'googlemeet', language 'pt_br', version '4.1'.
 *
 * @package     googlemeet
 * @category    string
...
$string['creatoremail'] = 'Email do organizador';
$string['creatoremail_error'] = 'Digite um email válido';
$string['creatoremail_help'] = 'Email do organizador do evento';
$string['date'] = 'Data';
...
$string['emailcontent_help'] = 'Quando uma notificação é enviada a um estudante, ele obtém o conteúdo do email desse campo. Os seguintes curingas podem ser usados:
<ul>
<li>%userfirstname%</li>
<li>%userlastname%</li>
<li>%coursename%</li>
...
$string['isnotcreatoremail'] = 'Entre com a conta do organizador ou altere o email do organizador nas configurações para sincronizar as gravações.';
...
$string['modulename_help'] = 'O módulo Google Meet™ para Moodle permite ao professor criar uma sala do Google Meet como recurso do curso e, após as reuniões, disponibilizar as gravações aos estudantes, salvas no Google Drive.
...
$string['notify_help'] = 'Se marcada, uma notificação será enviada ao estudante sobre a data de início do evento.';
...
$string['roomurl_caution'] = '<strong>Cuidado!</strong> Se a URL da sala ou o Email do organizador for alterado, as gravações já sincronizadas podem ser removidas na próxima sincronização.';
