...
/**
 * Strings for component 'enrol_database', language 'pt_br', version '4.1'.
 *
...
$string['remoteotheruserfield_desc'] = 'O nome do campo na tabela remota que estamos usando para marcar "Outro Usuário" na atribuição de papel.';
