...
/**
 * Strings for component 'quiz', language 'pt_br', version '4.1'.
 *
 * @package     quiz
 * @category    string
...
$string['alwayslatest'] = 'Sempre mais recente';
...
$string['decimalplacesquestion'] = 'Casas decimais nas notas das questões';
...
$string['notifyattemptsgradedtask'] = 'Enviar notificações de tentativa de questionário avaliada';
...
$string['privacy:metadata:quiz_attempts:gradednotificationsenttime'] = 'A hora em que o usuário foi notificado que a avaliação manual de sua tentativa foi concluída';
...
$string['questiondraftwillnotwork'] = 'Esta questão está como rascunho. Para utilizá-la no questionário, acesse o banco de questões e altere o status para pronta.';
...
$string['selectquestionslot'] = 'Selecionar questão {$a}';
...
$string['submission_confirmation'] = 'Enviar todas as suas respostas e finalizar?';
$string['submission_confirmation_unanswered'] = 'Questões sem resposta: {$a}';
...
$string['updatequizslotswithrandomxofy'] = 'Atualizando intervalos do questionário com dados de questões "aleatórias" ({$a->done}/{$a->total})';
