...
/**
 * Strings for component 'plugin', language 'pt_br', version '4.1'.
 *
 * @package     plugin
 * @category    string
...
$string['type_contenttype'] = 'Banco de conteúdo';
$string['type_contenttype_plural'] = 'Plugins do banco de conteúdo';
...
$string['type_qbank'] = 'Plugin de banco de questões';
$string['type_qbank_plural'] = 'Plugins de banco de questões';
