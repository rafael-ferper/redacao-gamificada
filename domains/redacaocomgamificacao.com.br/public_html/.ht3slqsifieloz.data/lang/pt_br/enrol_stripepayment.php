...
$string['connectionfailed'] = 'A conexão com Stripe falhou';
...
$string['couponapplied'] = 'Cupom Utilizado';
$string['couponcode'] = 'Código do cupom';
$string['couponcodedescription'] = 'Se você tiver algum cupom, utilize aqui';
$string['create_user_token'] = 'OBRIGATÓRIO: Para fazer o retorno de chamada do Stripe funcionar, você deve habilitar o protocolo Moodle REST em seu site';
...
$string['enabled_rest_protocol'] = 'Você também deve criar um token do serviço moodle_enrol_stripepayment com privilégio de administrador';
$string['enrol'] = 'Inscrever';
$string['enrol_btn_color'] = 'Escolha a cor do botão de inscrição';
$string['enrol_btn_color_des'] = 'Escolha seu próprio esquema de cores personalizado para o botão de  inscrição.';
...
$string['enrollsuccess'] = 'Obrigado! Agora você está inscrito no curso';
...
$string['invalidstripeparam'] = 'Parâmetros inválidos foram fornecidos para Stripe API';
$string['invaliduserid'] = 'Não é um ID de usuário válido!';
...
$string['notstripeerror'] = 'Algo mais aconteceu, completamente sem conexão com o Stripe';
...
$string['stripeauthfail'] = 'A autenticação com Stripe API falhou';
...
$string['unmatchedcourse'] = 'A ID do curso não corresponde às configurações do curso, recebido:';
