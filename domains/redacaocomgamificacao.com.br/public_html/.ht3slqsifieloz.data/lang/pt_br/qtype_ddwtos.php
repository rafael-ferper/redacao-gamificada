...
/**
 * Strings for component 'qtype_ddwtos', language 'pt_br', version '4.1'.
 *
...
$string['errorlimitedchoice'] = 'A opção [[{$a}]] foi usada mais de uma vez sem ser definida como "Ilimitada". Por favor, verifique novamente esta questão.';
...
$string['privacy:metadata'] = 'O plugin de tipo de questão Arrastar e soltar sobre o texto permite que os autores das questões definam opções padrão como preferências do usuário.';
