...
/**
 * Strings for component 'qcreate', language 'pt_br', version '4.1'.
 *
 * @package     qcreate
 * @category    string
...
$string['allowedqtypes_help'] = 'Aqui você especifica o tipo de questões que são permitidas. Se você selecionar \'Permitir todos os tipos de questão\', então os estudantes podem combinar qualquer tipo de questão para o total especificado em \'Total de Questões Avaliadas\'.';
...
$string['completionquestions'] = 'O estudante deve criar:';
$string['completionquestions_help'] = 'Se habilitada, essa atividade é considerada completa quando o estudante criou o número de questões (niveladas ou não).';
$string['completionquestionsdesc'] = 'O estudante deve criar pelo menos {$a} questão(ões)';
...
Você pode vê-la na página de atividade:
    ...
    {$a->url}';
$string['gradecomment'] = 'Comentário de avaliação';
...
$string['minimumquestions_help'] = 'Nesse menu, você pode especificar quantas questões de um tipo específico os estudantes devem criar.';
$string['modulename'] = 'Criação de Questão';
$string['modulename_help'] = 'A criação de questão habilita um professor a pedir aos estudantes para criar questões, número de questões requeridas, tipos de questão disponíveis e o número de questões requeridas de cada tipo de questão que pode ser especificado.';
...
$string['noofquestionstotal_help'] = 'Esse é o número total de questões que os estudantes devem criar. Esse número deve ser maior ou igual ao número mínimo de questões requerido.';
...
$string['open_help'] = 'Você pode especificar períodos em que a atividade de criação de questão fica acessível para pessoas criarem questões. Antes do tempo de abertura, e após o tempo de término,  os estudantes não são capazes de criar questões.';
...
$string['qcreate:receivestudentnotifications'] = 'Receber notificações de estudante';
...
$string['qtype_help'] = 'Nesse menu você pode especificar que tipo de questão os estudantes devem criar.';
...
$string['sendgradernotifications_help'] = 'Se habilitados, avaliadores (usualmente professores) recebem uma mensagem sempre que um estudante criar uma nova questão. Métodos de mensagem são configuráveis.';
$string['sendstudentnotifications'] = 'Notificar estudantes';
$string['sendstudentnotifications_help'] = 'Se habilitados, os estudantes recebem uma mensagem quando uma de suas questões é avaliada.';
$string['show'] = 'Mostrar';
...
$string['studentaccessheader'] = 'Acesso à questão do estudante';
...
$string['studentqaccess_help'] = 'Usar esse menu para definir quais direitos de acesso os estudantes têm sobre questões que eles criam.';
$string['studentshavedone'] = 'Estudantes criaram {$a} questão(ões).';
$string['synchronizeqaccesstask'] = 'Sincronizar capacidades de acesso das questões dos estudantes';
