...
$string['errorcontextcoursemismatchforwholesite'] = 'A URL desta página para o <em>Level up!</em> não corresponde à configuração atual do módulo. A configuração atual do <em>Level up!</em> determina que ele pode ser usado \'Em todo o site\'; no entanto, esta página espera que ele seja usado \'Por disciplina\'. Por favor, <a href="{$a->nexturl}">clique aqui</a> para acessar a página correta. Procure a configuração de administrador \'block_xp_context\' se pretender alterar esta definição.';
$string['errorcontextcoursemismatchpercourse'] = 'A URL desta página para o <em>Level up!</em> não corresponde à configuração atual do módulo. A configuração atual do <em>Level up!</em> determina que ele pode ser usado \'Por disciplina\'; no entanto, esta página espera que seja usado \'Em todo o site\'. Provavelmente, foi originado de um <em>bloco</em> que foi adicionado ao painel ou à primeira página em uma configuração diferente. O bloco precisará ser removido das últimas páginas e usado apenas em disciplinas individuais.';
...
$string['eventsrules_help'] = 'Este recurso usa os eventos para atribuir pontos às ações executadas pelos estudantes.
Utilize o formulário abaixo para adicionar as suas próprias regras e modificar as pré-definidas.

É recomendável verificar os logs do módulo para identificar quais eventos são acionados à medida que os estudantes realizam ações na disciplina.
...
Isto significa que o _Level up!_ foi atualizado, mas o _Level up! Plus_ ainda não. Embora sejam feitas tentativas para evitar problemas, alguns recursos podem não funcionar corretamente, incluindo o próprio _Level up!_. Recomendamos que o _Level up! Plus_ seja atualizado para a última versão. [Leia mais]({$a->url})';
...
$string['promocheatguard'] = 'A proteção contra fraude não foi projetada para cobrir longos períodos de tempo . Por favor, considere atualizar para a versão <em>Level up! Plus</em>, a fim de desbloquear prazos maiores e outros recursos. <a href="{$a->url} ">Leia mais</a>.';
...
$string['promointro'] = 'O plugin adicional _Level up! Plus_ possui recursos que motivam os estudantes e liberam todo o seu potencial!';
$string['promointroinstalled'] = 'O plugin adicional _Level up! Plus_ está instalado no sistema e todos os recursos foram habilitados.';
$string['promorulesdidyouknow'] = 'Você sabia que com o <em>Level up! Plus</em> os estudantes podem receber pontos para <em>concluir os cursos</em> e <em>as atividades</em> ou, até mesmo, receber pontos de acordo com as suas <em>notas</em>? <a href="{$a->url}">Leia mais</a>.';
