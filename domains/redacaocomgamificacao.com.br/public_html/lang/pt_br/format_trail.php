...
/**
 * Strings for component 'format_trail', language 'pt_br', version '4.1'.
 *
...
$string['formattrail'] = 'Formato de trilha';
...
$string['setcurrentselectedimagecontainercolour_help'] = 'Defina a cor atual do container de imagem selecionado em RGB hexadecimal. (999999 para transparente)';
...
$string['setimagecontaineralignment'] = 'Alinhamento de container de imagem';
$string['setimagecontaineralignment_help'] = 'Redefine o alinhamento do container de imagem para o valor padrão, de modo que ele será o mesmo que um curso na primeira vez que ele estiver no formato de trilha.';
...
$string['setshowcheckstar_help'] = 'Escolha o estilo de check que aparecerá quando o estudante concluir todas as atividades com critérios de conclusão da seção.';
