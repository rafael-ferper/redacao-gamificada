...
$string['emaildisplayhide'] = '(Ocultado de todos os usuários sem privilégio)';
...
$string['showactivitydates_help'] = 'As datas da atividade são mostradas na lista de atividades na página do curso. Esta configuração determina quando as datas da atividade serão mostradas abaixo de cada atividade na página do curso.';
...
$string['showgrades_help'] = 'Muitas atividades permitem que as notas sejam definidas. Essa configuração determina se um estudante pode visualizar uma lista de todas as suas notas no curso.';
