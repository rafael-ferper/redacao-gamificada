...
/**
 * Strings for component 'engagementindicator_assessment', language 'pt_br', version '4.1'.
 *
...
$string['localrisk_help'] = 'O percentual de risco somente dessa avaliação, em 100. O risco local é multiplicado pelo coeficiente de ponderação da avaliação para formar a Contribuição de Risco.';
$string['logic'] = 'Lógica';
