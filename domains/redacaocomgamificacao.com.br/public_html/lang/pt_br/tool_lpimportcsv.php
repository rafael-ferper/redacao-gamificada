...
/**
 * Strings for component 'tool_lpimportcsv', language 'pt_br', version '4.1'.
 *
...
$string['privacy:metadata'] = 'O plugin do quadro de competências Import não armazena nenhum dado pessoal.';
