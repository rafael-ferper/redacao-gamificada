...
/**
 * Strings for component 'attendanceregister', language 'pt_br', version '4.1'.
 *
...
$string['dayscertificable_help'] = 'Limite de quão antiga as sessões offline podem ser.<br />Um estudante não pode gravar uma sessão offline mais antiga do que esse número de dias.';
...
$string['force_recalc_all_session_help'] = 'Excluir e recalcular todas as sessões on-line de todos os usuários monitorados. <br />
Normalmente você <b>não precisa fazê-lo!</b><br />
Novas sessões são calculados automaticamente em segundo plano (depois de algum atraso).<br />
Esta operação pode ser útil <b>apenas:</b>
<ul>
<li>Depois de mudar o papel de um usuário que já atuou em qualquer um dos cursos monitorados com um papel diferente (ou seja, mudança de professor para estudante, quando os estudantes são rastreados e professores não são). </li>
<li>Depois de modificar as definições de registro que afeta  o cálculos das sessões (por exemplo, <i>o modo de rastreamento de atendimento, timeout de sessão online)</i> </li>
</ul>
Você <b>não precisa recalcular ao registrar novos usuários!</b> <br /><br />
Recálculo pode ser executado imediatamente ou agendada para a próxima execução do cron. Execução agendada pode ser mais eficiente para cursos muito lotados.';
...
$string['force_recalc_user_session_help'] = 'Excluir e recalcular todas as sessões on-line deste usuário. <br />
Normalmente você <b>não precisa fazê-lo!</b><br />
Novas sessões são calculados automaticamente em segundo plano (depois de algum atraso).<br />
Esta operação pode ser útil <b>apenas:</b>
<ul>
<li>Depois de mudar o papel do usuário que já atuou em qualquer um dos cursos monitorados com um papel diferente (ou seja, mudança de estudante para estudante, quando os estudantes são monitorados e professores não são). </li>
<li>Depois de modificar as definições de registro que afeta  o cálculos das sessões (por exemplo, <i>o modo de monitoramento de frequência, timeout de sessão online )</i></li>
</ul>';
