...
/**
 * Strings for component 'gradeimport_xml', language 'pt_br', version '4.1'.
 *
...
$string['privacy:metadata'] = 'O plugin de importação de notas Arquivo XML não armazena nenhum dado pessoal.';
