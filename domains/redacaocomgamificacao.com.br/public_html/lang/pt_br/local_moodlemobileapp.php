...
/**
 * Strings for component 'local_moodlemobileapp', language 'pt_br', version '4.1'.
 *
...
$string['addon.mod_data.edittagsnotsupported'] = 'Desculpe, a edição de tags não é compatível com o aplicativo.';
...
$string['addon.mod_data.searchbytagsnotsupported'] = 'Desculpe, a pesquisa por tags não é compatível com o aplicativo.';
...
$string['addon.mod_h5pactivity.errorgetactivity'] = 'Erro ao obter dados de atividade do H5P.';
$string['addon.mod_h5pactivity.filestatenotdownloaded'] = 'O pacote H5P não foi baixado ainda. Você precisa baixá-lo para poder usá-lo.';
...
$string['addon.mod_quiz.canattemptbutnotsubmit'] = 'Você pode submeter este questionário no aplicativo, mas precisará enviar a tentativa no navegador pelos seguintes motivos:';
...
$string['addon.mod_quiz.errorquestionsnotsupported'] = 'Esse questionário não pode ser submetido no aplicativo porque possui questões que não são suportadas pelo aplicativo:';
...
$string['addon.privatefiles.erroruploadnotworking'] = 'Infelizmente, atualmente não é possível fazer upload de arquivos para seu site.';
...
$string['addon.storagemanager.deletecourse'] = 'Limpar todos os dados do curso';
...
$string['core.ajaxendpointnotfound'] = '<p>Endpoint AJAX não encontrado. Isso pode acontecer se o site Moodle for muito antigo ou bloquear o acesso a esse endpoint. O aplicativo Moodle suporta apenas sistemas Moodle {{$a}} em diante. Entre em contato com o administrador do seu site.</p>
<p>{{whoisadmin}}</p>';
$string['core.browser'] = 'Navegador';
$string['core.calculating'] = 'Calculando';
$string['core.cannotconnect'] = 'Não foi possível conectar';
...
$string['core.cannotinstallapk'] = 'Por motivos de segurança, você não pode instalar aplicativos desconhecidos no seu dispositivo a partir deste aplicativo. Por favor, abra o arquivo usando um navegador.';
...
$string['core.cannotopeninappdownload'] = 'Este arquivo pode não funcionar conforme o esperado neste dispositivo. Você gostaria de baixá-lo de qualquer maneira?';
...
$string['core.certificaterror'] = '<p>O certificado deste site não é confiável para o seu dispositivo. Entre em contato com o administrador do seu site.</p>
<p>{{whoisadmin}}</p>';
...
$string['core.comments.commentsnotworking'] = 'Os comentários não podem ser recuperados';
...
$string['core.confirmgotabroot'] = 'Tem certeza de que deseja voltar para {{name}}?';
$string['core.confirmgotabrootdefault'] = 'Tem certeza de que deseja ir para a página inicial da aba atual?';
...
$string['core.course.cannotdeletewhiledownloading'] = 'Os arquivos não podem ser excluídos enquanto a atividade está sendo baixada. Por favor, espere o download terminar.';
...
$string['core.course.confirmdownloadzerosize'] = 'Você está prestes a iniciar o download. {{availableSpace}} Tem certeza de que deseja continuar?';
...
$string['core.course.downloadcoursesprogressdescription'] = 'Baixando cursos: baixado {{count}} de {{total}}.';
...
$string['core.erroropenfiledownloading'] = 'Erro ao abrir o arquivo: você precisa aguardar a conclusão do download.';
...
$string['core.errorsomedatanotdownloaded'] = 'Se você baixou esta atividade, tenha em mente que alguns dados não são baixados durante o processo de download por motivos de desempenho e uso.';
...
$string['core.errorurlschemeinvalidscheme'] = 'Esta URL deve ser usada em outro aplicativo: {{$a}}.';
...
$string['core.login.changepasswordhelp'] = 'Se você tiver problemas para alterar sua senha, entre em contato com o administrador do site. "Administradores do Site" são as pessoas que gerenciam o Moodle em sua escola/universidade/empresa ou organização de ensino. Se não souber como entrar em contato, por favor fale com os seus professores/formadores.';
...
$string['core.login.changepasswordlogoutinstructions'] = 'Se preferir mudar de site ou sair, clique no botão a seguir:';
$string['core.login.changepasswordreconnectinstructions'] = 'Clique no botão a seguir para se reconectar ao site. (Leve em conta que se você não alterasse sua senha com sucesso, você retornaria à tela anterior).';
...
$string['core.login.connecttomoodleapp'] = 'Você está tentando se conectar a um site Moodle normal. Faça o download do aplicativo oficial do Moodle para acessar este site.';
$string['core.login.connecttoworkplaceapp'] = 'Você está tentando se conectar a um site do Moodle Workplace. Faça o download do aplicativo Moodle Workplace para acessar este site.';
...
$string['core.login.errorexampleurl'] = 'A URL https://campus.example.edu é apenas uma URL de exemplo, não é um site real. <strong>Use a URL do site da sua escola ou organização.</strong>';
...
$string['core.login.faqcannotfindmysiteanswer'] = 'Você digitou o nome corretamente? Também é possível que seu site não esteja incluído em nosso diretório de sites públicos. Se você ainda não conseguir encontrá-lo, digite o endereço do seu site.';
$string['core.login.faqcannotfindmysitequestion'] = 'Não consigo encontrar meu site.';
...
$string['core.login.faqsetupsitequestion'] = 'Eu quero configurar meu próprio site Moodle.';
$string['core.login.faqtestappanswer'] = 'Para testar o aplicativo em um site de demonstração do Moodle, digite "professor" ou "estudante" no campo "Seu site" e clique no botão "Conectar ao seu site".';
$string['core.login.faqtestappquestion'] = 'Eu só quero testar o aplicativo, o que posso fazer?';
...
$string['core.login.faqwhereisqrcodeanswer'] = '<p>Se sua organização o ativou, você encontrará um QR code no site na parte inferior da página do seu perfil de usuário.</p>{{$image}}';
...
$string['core.login.invalidmoodleversion'] = '<p>Versão do site Moodle inválida. O aplicativo Moodle suporta apenas sistemas Moodle {{$a}} em diante.</p>
<p>Você pode entrar em contato com os administradores do seu site e pedir que eles atualizem o sistema Moodle.</p>
<p>"Administradores do Site" são as pessoas que gerenciam o Moodle em sua escola/universidade/empresa ou organização de aprendizagem. Se você não souber como entrar em contato, fale com seus professores/instrutores.</p>';
...
$string['core.login.onboardingprovidefeedback'] = 'Forneça feedback oportuno';
...
$string['core.login.signuprequiredfieldnotsupported'] = 'O formulário de inscrição contém um campo personalizado obrigatório que não é compatível com o aplicativo. Por favor, crie sua conta usando um navegador da web.';
...
$string['core.play'] = 'Iniciar';
$string['core.pulltorefresh'] = 'Puxe para atualizar';
$string['core.qrscanner'] = 'Leitor QR';
...
$string['core.question.errorembeddedfilesnotsupportedinsite'] = 'Seu site ainda não suporta a edição de arquivos incorporados.';
...
$string['core.scanqr'] = 'Digitalizar o QR code';
...
$string['core.settings.copyinfo'] = 'Copie as informações do dispositivo na área de transferência';
...
$string['core.settings.enablefirebaseanalytics'] = 'Ativar análise do Firebase';
$string['core.settings.enablefirebaseanalyticsdescription'] = 'Se ativado, o aplicativo coletará o uso de dados anônimos.';
...
$string['core.settings.forcedsetting'] = 'Essa configuração foi forçada pela configuração do seu site.';
...
$string['core.updaterequireddesc'] = 'Atualize seu aplicativo para a versão {{$a}}';
...
<p><b>{{url}}</b></p>';
$string['core.whoissiteadmin'] = '"Administradores do Site" são as pessoas que gerenciam o Moodle em sua escola/universidade/empresa ou organização de aprendizado. Se não souber como contactá-los, por favor contacte os seus professores/formadores.';
...
$string['core.youreoffline'] = 'Você está offline';
$string['core.youreonline'] = 'Você está online novamente';
