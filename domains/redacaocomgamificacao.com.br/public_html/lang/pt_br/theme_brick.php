...
/**
 * Strings for component 'theme_brick', language 'pt_br', version '4.1'.
 *
 * @package     theme_brick
 * @category    string
...
$string['headingcolor'] = 'Cor do cabeçalho';
$string['headingcolordesc'] = 'Essa é a cor do cabeçalho para títulos grandes (notícias do site, meus cursos) e outros títulos.';
...
$string['linkhoverdesc'] = 'Defina a cor dos links (em foco) no tema, use o código hexadecimal html.';
...
$string['maincolordesc'] = 'Definir o código hexadecimal da cor do cabeçalho, barra dock e outras áreas. Desejável uma cor escura ou saturada.';
$string['maincolorlink'] = 'Cor principal do link';
$string['maincolorlinkdesc'] = 'Cor do link para a barra de menu e títulos dos blocos.';
