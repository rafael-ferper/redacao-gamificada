...
/**
 * Strings for component 'booktool_exportimscp', language 'pt_br', version '4.1'.
 *
...
$string['generateimscp'] = 'Baixar IMS CP';
...
$string['privacy:metadata'] = 'O plugin de exportação Book IMS CP não armazena nenhum dado pessoal.';
