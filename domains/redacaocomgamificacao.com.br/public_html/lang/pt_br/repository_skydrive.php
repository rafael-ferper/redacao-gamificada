...
/**
 * Strings for component 'repository_skydrive', language 'pt_br', version '4.1'.
 *
...
$string['privacy:metadata'] = 'O plugin do repositório OneDrive (legado) não armazena nenhum dado pessoal, mas transmite os dados do usuário do Moodle para o sistema remoto.';
