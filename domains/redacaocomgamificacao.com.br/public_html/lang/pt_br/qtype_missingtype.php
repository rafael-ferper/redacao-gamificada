...
/**
 * Strings for component 'qtype_missingtype', language 'pt_br', version '4.1'.
 *
...
$string['privacy:metadata'] = 'O plugin de tipo de questão Escolha as palavras que faltam não armazena nenhum dado pessoal.';
$string['warningmissingtype'] = '<b>Esta questão é de um tipo que ainda não foi instalado em seu Moodle. <br />Informe, por favor, o seu administrador do Moodle.</b>';
