...
/**
 * Strings for component 'simplecertificate', language 'pt_br', version '4.1'.
 *
...
$string['cantissue'] = 'O certificado não pode ser emitido pois o usuário não atingiu as metas do curso';
...
<ul>
<li>{USERNAME} -> Nome completo do estudante</li>
...
"PROFILE_ANIVERSARIO"
O texto pode ser um HTML básico, com fontes básicas do HTML, tabelas, mas evite utilizar o uso de posicionamento.';
...
$string['delivery_help'] = 'Escolha como o certificado deve ser entregue aos estudantes:<br>
<ul>
<li>Visualizar em uma nova janela: Abre uma nova janela no navegador do estudante contendo o certificado.</li>
<li>Forçar o download: Abre uma janela de download de arquivo para o estudante salvar em seu computador.</li>
<li>por Email: Envia o certificado para o email do estudante, e abre o certificado em uma nova janela do navegador.</li>
</ul><p>
...
$string['multipdf'] = 'Download de um arquivo zip com os pdfs dos certificados';
