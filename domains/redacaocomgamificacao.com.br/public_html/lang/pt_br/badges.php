...
/**
 * Strings for component 'badges', language 'pt_br', version '4.1'.
 *
 * @package     badges
 * @category    string
...
$string['addbackpack'] = 'Adicionar mochila';
...
$string['attachment_help'] = 'Se habilitado, um arquivo do emblema emitido será anexado ao email do destinatário para download. (Para usar esta opção a configuração de permitir anexos deve estar habilitada em Administração do site / Servidor /Email / Configuração de saída de email.)';
...
$string['backpackconnection_help'] = 'Conectar a uma mochila permite que você compartilhe seus emblemas desse site e exiba coleções públicas de emblemas de sua mochila na sua página de perfil nesse site.';
...
$string['backpackconnectionunexpectedresult'] = 'Ocorreu um problema ao conectar a sua mochila. Por favor  verifique suas credenciais e tente novamente.';
...
Uma nova conexão com sua mochila de emblemas foi solicitada em \'{$a->sitename}\' usando o seu endereço de email.

Para confirmar e ativar a conexão para sua mochila, por favor acesse

{$a->link}

Na maioria de programas de email, esse endereço deve aparecer como um link azul que você pode clicar. Se isso não funcionar, copie e cole o endereço na barra de endereços, localizada na parte superior, do seu navegador.

Se você precisar de ajuda, entre em contato com o administrador do site,
{$a->admin}';
...
$string['backpackneedsupdate'] = 'A mochila conectada a esse perfil não corresponde a mochila do site. Você precisa desconectar e reconectar a mochila.';
...
$string['defaultissuercontact_desc'] = 'Um endereço de email associado ao emissor do emblema. Para uma mochila Open Badges v2.0, isso é usado para autenticação ao publicar emblemas em uma mochila.';
...
$string['defaultissuerpassword_help'] = 'É necessária uma conta no site da mochila com o endereço de email, conforme especificado na configuração do endereço de email do emissor do emblema em Administração do site / Emblemas / Configurações de emblemas. A senha da conta deve ser inserida aqui.';
...
$string['sitebackpack'] = 'Mochila externa ativa';
$string['sitebackpack_help'] = 'A mochila externa que os usuários podem se conectar a partir deste site. Observe que a alteração dessa configuração após os usuários conectarem suas mochilas exigirá que cada usuário acesse a página de configurações da mochila, desconecte e reconecte.';
