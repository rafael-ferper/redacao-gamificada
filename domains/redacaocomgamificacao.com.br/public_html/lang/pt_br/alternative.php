...
/**
 * Strings for component 'alternative', language 'pt_br', version '4.1'.
 *
 * @package     alternative
 * @category    string
...
$string['instructionsforcereg'] = 'Você não pode se registar, mas o seu papel permite que você registre os estudantes para qualquer opção.';
...
$string['modulename_help'] = 'O módulo alternativa permite aos estudantes registrar uma ou várias escolhas em uma determinada lista.';
...
$string['synthpotential'] = 'Potenciais estudantes';
$string['synthregistered'] = 'Estudantes matriculados';
