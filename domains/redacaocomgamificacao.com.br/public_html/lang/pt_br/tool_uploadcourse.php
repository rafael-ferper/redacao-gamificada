...
/**
 * Strings for component 'tool_uploadcourse', language 'pt_br', version '4.1'.
 *
...
$string['cannotupdatefrontpage'] = 'Você não ter permissão para modificar a página inicial.';
...
$string['csvdelimiter_help'] = 'O caractere que separa a sequência de dados em cada registro.';
$string['csvfileerror'] = 'Há algo de errado com o formato do arquivo. Por favor, verifique se o número de títulos e colunas correspondentes, e se o delimitador e codificação do arquivo estão corretos: {$a}';
...
* Cada registro é uma sequência de dados separados pelo delimitador definido
* A primeira linha contém uma lista com o nome dos campos que definem o formato do restante dos registros do arquivo
