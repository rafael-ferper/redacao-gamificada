...
/**
 * Strings for component 'tool_certificate', language 'pt_br', version '4.1'.
 *
...
$string['certificatesissues'] = 'Emissões de certificados';
...
$string['elementwidth'] = 'Largura, mm';
...
$string['entitycertificateissue'] = 'Emissão de certificado';
$string['entitycertificateissues'] = 'Emissões de certificados';
$string['errornopermissionissuecertificate'] = 'Você não tem permissão para emitir esse certificado';
...
$string['issuenewcertificates'] = 'Emitir novos certificados';
...
$string['leftmargin'] = 'Margem esquerda, mm';
...
$string['mappingerrorcertificateheader'] = 'Alguns modelos de certificados não existem';
$string['mappingerrorcertificatelog'] = 'Certificado {$a} não foi encontrado';
...
$string['outcomecertificatedescription'] = 'Emitir certificado \'{$a}\' para os usuários';
$string['page'] = 'Página {$a}';
$string['pageheight'] = 'Altura da página, mm';
...
$string['pagewidth'] = 'Largura da página, mm';
...
$string['pluginname'] = 'Ferramenta Certificado';
$string['point'] = 'pt';
$string['posx'] = 'Posição X, mm';
...
$string['rightmargin'] = 'Margem direita, mm';
$string['rightmargin_help'] = 'Essa é a margem direita do PDF em mm.';
$string['selectcertificate'] = 'Selecionar o certificado';
...
$string['subplugintype_certificateelement_plural'] = 'Plugins de elemento';
$string['timecreated'] = 'Data de criação';
$string['toomanycertificatestoshow'] = 'Muitos certificados ({$a}) para mostrar';
$string['type'] = 'Tipo';
