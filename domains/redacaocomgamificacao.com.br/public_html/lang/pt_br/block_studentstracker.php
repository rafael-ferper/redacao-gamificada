...
/**
 * Strings for component 'block_studentstracker', language 'pt_br', version '4.1'.
 *
...
$string['pluginname'] = 'Monitoramento de Estudante';
$string['role'] = 'Rastrear todos os papéis ?';
$string['roles'] = 'Papéis permitidos para ver o bloco';
$string['roletrack'] = 'Monitorar papéis';
$string['roleview'] = 'Papéis com permissão de ver o bloco';
$string['studentstracker:addinstance'] = 'Adicionar um novo bloco Rastrear Estudante';
$string['studentstracker:editadvance'] = 'Edição avançada dentro do bloco';
$string['studentstracker:view'] = 'Ver resultados do monitoramento de estudantes';
