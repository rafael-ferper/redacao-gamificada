...
$string['configcustommenuitems'] = 'Um menu personalizado pode ser configurado aqui. Insira cada item de menu em uma nova linha com formato: texto de menu, um URL de link (opcional, não se aplica para itens de menu superior com subitens), um texto que será exibido em um tooltip (opcional) e um código ou uma lista de códigos de idioma separada por vírgulas (opcional, para exibir a linha apenas para usuários do idioma definido). Os itens que compõem a linha devem ser separados pelo caracter pipe (barra vertical). As linhas que começam com um hífen aparecerão como subitens do item de menu de nível superior e ### insere uma linha divisora. Por exemplo:
<pré>
Cursos
-Todos os cursos|/curso/
-Pesquisa de curso|/course/search.php
-###
-FAQ|https://example.org/faq
-Preguntas más frecuentes|https://example.org/pmf||es
Aplicativo móvel|https://example.org/app|Baixe nosso aplicativo
</pre>';
...
$string['configsupportpage'] = 'Um link para essa página será forneceido para os usuários para contactarem o suporte do site. Se esse campo for deixado em branco, então um link para um formulário de suporte será fornecido.';
...
$string['enroladminnewcourse_help'] = 'Quando um administrador adiciona um novo curso, ele deve ser automaticamente inscrito e atribuído à função de criador em novos cursos?';
...
$string['navshowfrontpagemods_help'] = 'Se habilitado, as atividades da página principal serão exibidas na navegação abaixo das páginas do site. Esta configuraç';
