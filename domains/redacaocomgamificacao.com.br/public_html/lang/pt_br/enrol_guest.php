...
/**
 * Strings for component 'enrol_guest', language 'pt_br', version '4.1'.
 *
 * @package     enrol_guest
 * @category    string
...
$string['privacy:metadata'] = 'O plugin de inscrição Acesso como Visitante não armazena nenhum dado pessoal.';
