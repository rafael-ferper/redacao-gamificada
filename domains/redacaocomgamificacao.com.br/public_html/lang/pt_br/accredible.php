...
$string['accredible:addinstance'] = 'Adicionar uma instância de certificado/emblema';
$string['accredible:manage'] = 'Gerenciar uma instância certificado/emblema';
...
$string['privacy:metadata:accredible:email'] = 'Seu endereço de e-mail é enviado para a plataforma Accredible para emitir uma credencial.';
$string['privacy:metadata:accredible:fullname'] = 'Seu nome completo é enviado à plataforma Accredible para emitir uma credencial.';
