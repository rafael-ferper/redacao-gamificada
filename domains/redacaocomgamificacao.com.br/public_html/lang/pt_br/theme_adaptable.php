...
/**
 * Strings for component 'theme_adaptable', language 'pt_br', version '4.1'.
 *
...
$string['alertcolorsheading'] = 'Customizar parte superior das caixas de alerta';
...
$string['alerthiddencourse'] = 'Habilitar alertas de curso';
$string['alerthiddencoursedesc'] = 'Mostrar alertas na página do curso.';
...
$string['alertwarningdesc'] = 'Exibir um aviso na caixa de alerta.';
...
$string['buttoncolorscnd'] = 'A cor do botão secundário';
...
$string['buttonhovercolorcancel'] = 'A cor do botão cancelar (quando flutuando)';
...
$string['buttonhovercolorscnd'] = 'A cor do botão secundário (quando flutuando)';
...
$string['buttontextcolordesccancel'] = 'A cor do texto usada nos botões Cancelar';
$string['buttontextcolordescscnd'] = 'A cor do texto usada nos botões secundários.';
$string['buttontextcolorscnd'] = 'A cor do texto dos botões secundários.';
...
<div class = "well">
<h3>Sobre</h3>
<p>Adaptable é um tema responsivo de 2 colunas do Moodle, altamente personalizável e baseado no popular tema BCU. A versão 2 está usando
 Boost como tema base e, portanto, Bootstrap 4.</p>
<p>O tema está licenciado sob a GPL (GNU General Public License). Você pode encontrar uma cópia completa da licença <a href="http://www.gnu.org/licenses/" target="_blank">aqui</a></p>
<br>
<h4> Modifique! - Melhore! - Compartilhe!</h4>
<br>
<h3>Créditos</h3>
<p>Este tema foi desenvolvido por:<br>
Jeremy Hopkins (Universidade de Coventry)<br>
Fernando Acedo (<a href="https://3-bits.com" target="_blank">3-bits.com</a>) </p>
Manoj Solanki (Universidade de Coventry)<br>
<br>
<h2>Outros créditos</h2>
<p>No desenvolvimento da versão 2, eles também colaboraram:<br>
Gareth J. Barnard (http://moodle.org/user/profile.php?id=442195)
Stuart Lamour
Alistair Spark (Universidade de Londres)
<br>
<p> entre muitos outros desenvolvedores, testadores, tradutores e voluntários (consulte <a href="adaptable/README.txt" target="_blank"> README.txt </a>) </p>
<br>
<h3>Relatório de erros</h3>
<p>Você pode relatar bugs (e, por favor, APENAS</b> bugs) em nosso <a href="https://gitlab.com/3bits/moodle-theme_adaptable2" target="_blank">repositório</a></p>
<br>
<h3>Suporte técnico</h3>
<p>Você pode fazer suas perguntas no fórum do moodle:</p>
<ul>
<li>Português: <a href="https://moodle.org/mod/forum/discuss.php?d=340404" target="_blank">https://moodle.org/mod/forum/discuss. php?d=340404</a>
<li>Espanhol: <a href="https://moodle.org/mod/forum/discuss.php?d=326804" target="_blank">https://moodle.org/mod/forum/discuss. php?d=326804</a>
<li>Catalão: <a href="https://moodle.org/mod/forum/discuss.php?d=340406" target="_blank">https://moodle.org/mod/forum/discuss. php?d=340406</a>
</ul>
<br>
<h3>Demonstração</h3>
<p>Você pode ver uma versão demo <a href="https://adaptable.ws/demo" target="_blank"> AQUI </a> </p>
</div>
</div>';
...
$string['coursesectionactivityassignbgcolordesc'] = 'Definir a cor de fundo da atividade Tarefa. Digite <strong>transparent</strong> na caixa para transparência.';
...
$string['coursesectionactivityforumbgcolordesc'] = 'Definir a cor de fundo da atividade Fórum. Digite <strong>transparent</strong> na caixa para transparência.';
...
$string['coursesectionactivityquizbgcolordesc'] = 'Defina a cor de fundo da atividade Questionário. Digite <strong>transparent</strong> na caixa para transparência.';
...
$string['frontpagenumbertilesdesc'] = 'Número de blocos de cursos a serem exibidos por linha na lista de cursos da página principal';
...
$string['headerstyledesc'] = 'Escolher o estilo do cabeçalho. O cabeçalho 1 é o cabeçalho de 3 linhas original do Adaptable. O cabeçalho 2 é um cabeçalho mínimo de 2 linhas. Observe que, ao usar o Cabeçalho 2, na configuração "Usar caixa de pesquisa ou ícones sociais", sempre será usada uma caixa de pesquisa.';
...
$string['invalidcategorygeneratedcss'] = 'Categoria personalizada inválida CSS gerado: \'{$a->css}\'.';
...
$string['mobileslidebartabbkcolor'] = 'Cor de fundo da aba da barra lateral';
$string['mobileslidebartabbkcolordesc'] = 'A cor de fundo da barra lateral em dispositivos móveis (recolhida)';
$string['mobileslidebartabiconcolor'] = 'Cor do ícone da aba da barra lateral';
$string['mobileslidebartabiconcolordesc'] = 'A cor do ícone da barra lateral em dispositivos móveis (recolhido)';
...
$string['navbarmenusettings'] = 'Menu Personalizado da Barra de Navegação';
$string['navbarmenusettingsdesc'] = 'Permitir que você adicione um menu na barra de navegação';
$string['navbarmenusettingsheading'] = 'Personaliza o menu na barra de navegação. Veja o layout <a href="./../theme/adaptable/pix/layout.png" target="_blank"> aqui</a>.';
...
$string['responsivepagefooterdesc'] = 'Em quais tamanho de telas você gostaria que o Rodapé fosse exibido?';
...
$string['sidebarnotlogged'] = 'Mostrar barra lateral quando não estiver logado';
$string['sidebarnotloggeddesc'] = 'Mostrar os blocos da barra lateral quando o usuário não estiver logado';
